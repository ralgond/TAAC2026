...
class GatedFusion(nn.Module):
    ...
    def __init__(
        ...
        self.deepfm_hidden_dim = deepfm_hidden_dim
        self.behavior_hidden_dim = behavior_hidden_dim

        gate_in_dim = deepfm_hidden_dim + behavior_hidden_dim
        ...
        # Normalise each tower's hidden vector before feeding the gate so
        # that scale differences between DeepFM (BatchNorm output) and
        # BehaviorEncoder (Transformer output) do not bias gate weights.
        self.deepfm_ln = nn.LayerNorm(deepfm_hidden_dim)
        self.behavior_ln = nn.LayerNorm(behavior_hidden_dim)
    ...
    def forward(
        ...
        gate = self.gate(
            self.deepfm_ln(deepfm_hidden),
            self.behavior_ln(behavior_hidden),
        )
    ...
    def get_config(self) -> dict:
        return {
            ...
            "deepfm_hidden_dim": self.deepfm_hidden_dim,
